...
- [ ] Task: Search the codebase to locate all files importing from `langchain.schema`.
- [ ] Task: Create or locate existing tests for the affected modules and ensure they capture the expected behavior (Red Phase).
